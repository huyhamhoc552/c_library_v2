...
#define MAVLINK_MSG_ID_CUSTOM_MSG 402


typedef struct __mavlink_custom_msg_t {
 float packett; /*< [packet] Packet Number*/
 float dataa; /*< [unit] Data Values*/
} mavlink_custom_msg_t;

#define MAVLINK_MSG_ID_CUSTOM_MSG_LEN 8
#define MAVLINK_MSG_ID_CUSTOM_MSG_MIN_LEN 8
#define MAVLINK_MSG_ID_402_LEN 8
#define MAVLINK_MSG_ID_402_MIN_LEN 8

#define MAVLINK_MSG_ID_CUSTOM_MSG_CRC 19
...
#define MAVLINK_MESSAGE_INFO_CUSTOM_MSG { \
    ...
    "CUSTOM_MSG", \
    2, \
    {  { "packett", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_custom_msg_t, packett) }, \
         { "dataa", NULL, MAVLINK_TYPE_FLOAT, 0, 4, offsetof(mavlink_custom_msg_t, dataa) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_CUSTOM_MSG { \
 ...
 *
 * @param packett [packet] Packet Number
 * @param dataa [unit] Data Values
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_custom_msg_pack_status(uint8_t system_id, uint8_t component_id, mavlink_status_t *_status, mavlink_message_t* msg,
                               float packett, float dataa)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_CUSTOM_MSG_LEN];
    ...
    return mavlink_finalize_message_buffer(msg, system_id, component_id, _status, MAVLINK_MSG_ID_CUSTOM_MSG_MIN_LEN, MAVLINK_MSG_ID_CUSTOM_MSG_LEN, MAVLINK_MSG_ID_CUSTOM_MSG_CRC);
#else
    return mavlink_finalize_message_buffer(msg, system_id, component_id, _status, MAVLINK_MSG_ID_CUSTOM_MSG_MIN_LEN, MAVLINK_MSG_ID_CUSTOM_MSG_LEN);
#endif
}
...
{
    return mavlink_msg_custom_msg_pack(system_id, component_id, msg, custom_msg->packett, custom_msg->dataa);
}
...
{
    return mavlink_msg_custom_msg_pack_chan(system_id, component_id, chan, msg, custom_msg->packett, custom_msg->dataa);
}

/**
 * @brief Encode a custom_msg struct with provided status structure
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param status MAVLink status structure
 ...
 * @param custom_msg C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_custom_msg_encode_status(uint8_t system_id, uint8_t component_id, mavlink_status_t* _status, mavlink_message_t* msg, const mavlink_custom_msg_t* custom_msg)
{
    return mavlink_msg_custom_msg_pack_status(system_id, component_id, _status, msg,  custom_msg->packett, custom_msg->dataa);
}
...
static inline void mavlink_msg_custom_msg_send(mavlink_channel_t chan, float packett, float dataa)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_CUSTOM_MSG_LEN];
    _mav_put_float(buf, 0, packett);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_custom_msg_send(chan, custom_msg->packett, custom_msg->dataa);
#else
 ...
 */
static inline void mavlink_msg_custom_msg_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float packett, float dataa)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field packett from custom_msg message
 *
 * @return [packet] Packet Number
 */
static inline float mavlink_msg_custom_msg_get_packett(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  0);
}

/**
 * @brief Get field dataa from custom_msg message
 *
 * @return [unit] Data Values
 */
static inline float mavlink_msg_custom_msg_get_dataa(const mavlink_message_t* msg)
{
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    custom_msg->packett = mavlink_msg_custom_msg_get_packett(msg);
    custom_msg->dataa = mavlink_msg_custom_msg_get_dataa(msg);
#else
